  ...
  return (
    <Box sx={{ p: 3 }}>
      <Typography variant="h4" component="h1" gutterBottom>
        14. Szakmai bemutatók, konferenciák, szakmai rendezvények
      </Typography>

      <Typography variant="body1" color="text.secondary" sx={{ mb: 3 }}>
        Minden olyan jellegű szakmai bemutató, konferencia, rendezvény ide kell
        sorolni, amely az intézmény vagy más szervezetek szakmai tudásának az
        átadását támogatja, különösen, amelynek a fő szervezője az intézmény.
      </Typography>
