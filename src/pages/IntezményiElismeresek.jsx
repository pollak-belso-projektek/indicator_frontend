  ...
  return (
    <Box sx={{ p: 3 }}>
      <Typography variant="h4" component="h1" gutterBottom>
        13. Intézményi elismerések
      </Typography>

      <Typography variant="body1" color="text.secondary" sx={{ mb: 3 }}>
        Az indikátor értékeléséhez nem az egyéni kitüntetések, díjak,
        elismerések figyelembevétele szükséges, hanem az intézmény, mint
        szervezetet érintő elismerések összegyűjtése.
      </Typography>
