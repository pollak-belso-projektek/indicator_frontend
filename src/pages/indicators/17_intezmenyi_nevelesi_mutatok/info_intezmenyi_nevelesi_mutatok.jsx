  ...
  return (
    <Box sx={{ display: "flex", flexDirection: "column", gap: 1 }}>
      ...
      <Typography variant="body2" color="text.primary" sx={{ mb: 2 }}>
        A mutató az adott tanévre vonatkozóan tartalmazza információt a fegyelmi
        esetek, dicséretek és az igazgatói mulasztások számáról a tanulói
        jogviszonyban tanulók esetén.
      </Typography>
      ...
      <Box sx={{ mt: 2, p: 2, backgroundColor: "#f0f8ff", borderRadius: 1 }}>
        ...
        <Typography variant="body2" sx={{ mb: 1 }}>
          Fegyelmi esetek száma: 186 db/tanév (A mutató megcsináló típusokként
          is: igazgatói figyelmeztetés 21 db/tanév, igazgatói megrovás 2
          db/tanév stb.)
        </Typography>
        <Typography variant="body2" sx={{ mb: 1 }}>
