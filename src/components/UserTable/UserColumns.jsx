                ...
                <HStack spacing={1} flexWrap="wrap">
                    {access.map(item => (
                        <Badge
                            ...
                            variant="solid"
                            colorPalette={
                                item.permissionsDetails.canRead ? 'green' :
                                    item.permissionsDetails.canUpdate ? 'blue' :
                                        item.permissionsDetails.canCreate ? 'orange' :
                                            item.permissionsDetails.canDelete ? 'red' :
                                                'gray'
                            }
                        >
                            {item.tableName}
