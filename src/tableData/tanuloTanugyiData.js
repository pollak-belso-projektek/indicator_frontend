export const fields = [
  ...
  },
  {
    ...
    alternateMatches: ["Jogviszonyát szüneteltető", "jogviszonyátSzunetelteto"],
    fieldType: {
      type: "input",
    },
    example: "False",
  ...
  {
    label: "A 9. évfolyamosok közül a 8. évfolyamot az előző tanévben végezte",
  ...
  },
  {
    ...
    validations: [
      {
        rule: "required",
        errorMessage: "Számítógépet tanulási/oktatási célra használ kötelező!",
      },
    ],
  },
  {
...

  {
    ...
    alternateMatches: ["Egyéni munkarend kezdete", "Egyeni_munkarend_kezdete"],
    fieldType: {
      type: "input",
    },
    example: "2025-05-21",
  ...
  },
  {
    ...
    fieldType: { type: "input" },
    example: "na",
    validation: [{ rule: "required", errorMesage: "Részszakma Kötelező mező" }],
  },
  {
  ...
  },
  {
    ...
    fieldType: { type: "input" },
    example: "Teljesitve",
    validation: [{ errorMesage: "Ágazati alapvizsga eredmény Kötelező mező" }],
  },
];
